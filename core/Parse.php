...
EOF;
 ...
 $replacement = '
  <img class="lazyload lazyload-style-2" data-fancybox="post-'.$obj->cid.'" data-caption="$2" src="data:image/svg+xml;base64,PCEtLUFyZ29uTG9hZGluZy0tPgo8c3ZnIHdpZHRoPSIxIiBoZWlnaHQ9IjEiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyIgc3Ryb2tlPSIjZmZmZmZmMDAiPjxnPjwvZz4KPC9zdmc+" data-src="$1" alt="$2" style="border-radius:3px;cursor: zoom-in;width:100%;height:auto;margin:10px 0 10px 0;">'; 
