        ...
        public static function get_enqueue_style($header = null)
        {
            ...
            if ($loads_statics) { // if is plugin
                ...
                $style = '<link rel="stylesheet" href="//lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/5.15.4/css/all.min.css?ver=5.15.4">' .
                    ...
                    '<link href="//cdn.staticfile.net/fomantic-ui/2.9.3/semantic.min.css" rel="stylesheet">' .
        ...
        public static function get_enqueue_script($old = null)
        {
            ...
            if ($loads_statics) { // if is plugin
                ...
                $script = '<script src="' . self::include_plugin_url('assets/js/lodash.min.js') . '?v=1"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/plugins.min.js') . '?v=1"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/main.min.js') . '?v=1"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/backend.js') . '?v=2"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/iris.min.js') . '?v=1"></script>' .
                    '<script src="//cdn.staticfile.org/jquery-tokeninput/1.6.0/jquery.tokeninput.min.js?v=1"></script>'.
                    '<script src="' . self::include_plugin_url('assets/js/color-picker.min.js') . '?v=1"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/jquery/ui/core.min.js') . '?v=1"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/jquery/ui/draggable.min.js') . '?v=1"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/jquery/ui/mouse.min.js') . '?v=1"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/jquery/ui/menu.min.js') . '?v=1"></script>' .
                    '<script src="//lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/toastr.js/2.1.4/toastr.min.js?v=1"></script>'.
                    '<script src="//cdn.staticfile.org/fomantic-ui/2.9.2/semantic.min.js?v=1"></script>' .
